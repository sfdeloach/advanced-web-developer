// Write a function called copyObject, which accepts one parameter, an object. The function should
...
// Write a function called checkIfFinite which accepts one parameter and returns true if that
// parameter is a finite number.

// checkIfFinite(4); // true
// checkIfFinite(-3); // true
// checkIfFinite(4.2); // true
...
function areAllNumbersFinite(nums) {
  return nums.every(Number.isFinite);
}

// Write a function called convertArrayLikeObject which accepts a single parameter, an array like
// object. The function should return the array like object converted to an array.
...
// Write a function called displayEvenArguments which accepts a variable number of arguments and
// returns a new array with all of the arguments that are even numbers.

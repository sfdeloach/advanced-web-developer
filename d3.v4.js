...
(function (global, factory) {
  ...
  function histogram() {
    ...
    histogram.thresholds = function (_) {
      return arguments.length
        ? ((threshold =
            typeof _ === 'function' ? _ : Array.isArray(_) ? constant(slice.call(_)) : constant(_)),
          histogram)
        : threshold;
    };
  ...
  function axis(orient, scale) {
    ...
    function axis(context) {
      ...
      path = path.merge(
        path.enter().insert('path', '.tick').attr('class', 'domain').attr('stroke', '#000')
      );
  ...
  function collide(radius) {
    ...
    force.radius = function (_) {
      return arguments.length
        ? ((radius = typeof _ === 'function' ? _ : constant$6(+_)), initialize(), force)
        : radius;
    };
  ...
  function link(links) {
    ...
    force.strength = function (_) {
      return arguments.length
        ? ((strength = typeof _ === 'function' ? _ : constant$6(+_)), initializeStrength(), force)
        : strength;
    };

    force.distance = function (_) {
      return arguments.length
        ? ((distance = typeof _ === 'function' ? _ : constant$6(+_)), initializeDistance(), force)
        : distance;
    };
  ...
  function manyBody() {
    ...
    force.strength = function (_) {
      return arguments.length
        ? ((strength = typeof _ === 'function' ? _ : constant$6(+_)), initialize(), force)
        : strength;
    };
  ...
  function x$2(x) {
    ...
    force.x = function (_) {
      return arguments.length
        ? ((x = typeof _ === 'function' ? _ : constant$6(+_)), initialize(), force)
        : x;
    };
  ...
  function y$2(y) {
    ...
    force.y = function (_) {
      return arguments.length
        ? ((y = typeof _ === 'function' ? _ : constant$6(+_)), initialize(), force)
        : y;
    };
  ...
  function precisionPrefix(step, value) {
    return Math.max(
      0,
      Math.max(-8, Math.min(8, Math.floor(exponent$1(value) / 3))) * 3 - exponent$1(Math.abs(step))
    );
  }
  ...
  function forwardRotationLambda(deltaLambda) {
    return function (lambda, phi) {
      return (
        (lambda += deltaLambda),
        [lambda > pi$3 ? lambda - tau$3 : lambda < -pi$3 ? lambda + tau$3 : lambda, phi]
      );
    };
  }
  ...
  function circle() {
    ...
    circle.center = function (_) {
      return arguments.length
        ? ((center = typeof _ === 'function' ? _ : constant$7([+_[0], +_[1]])), circle)
        : center;
    };

    circle.radius = function (_) {
      return arguments.length
        ? ((radius = typeof _ === 'function' ? _ : constant$7(+_)), circle)
        : radius;
    };

    circle.precision = function (_) {
      return arguments.length
        ? ((precision = typeof _ === 'function' ? _ : constant$7(+_)), circle)
        : precision;
    };
  ...
  function index$1(projection, context) {
    ...
    path.projection = function (_) {
      return arguments.length
        ? ((projectionStream =
            _ == null ? ((projection = null), identity$4) : (projection = _).stream),
          path)
        : projection;
    };
    ...
    path.context = function (_) {
      ...
      contextStream =
        _ == null ? ((context = null), new PathString()) : new PathContext((context = _));
  ...
  function projectionMutator(projectAt) {
    var project,
      ...
      x1,
      y1,
      postclip = identity$4, // clip extent
      delta2 = 0.5,
    ...
    projection.clipAngle = function (_) {
      return arguments.length
        ? ((preclip = +_ ? clipCircle((theta = _ * radians)) : ((theta = null), clipAntimeridian)),
          reset())
        : theta * degrees$1;
    };
  ...
  function identity$5() {
    ...
    return (projection = {
      ...
      scale: function (_) {
        return arguments.length
          ? ((transform$$1 = scaleTranslate((k = +_) * sx, k * sy, tx, ty)), reset())
          : k;
      },
      translate: function (_) {
        return arguments.length
          ? ((transform$$1 = scaleTranslate(k * sx, k * sy, (tx = +_[0]), (ty = +_[1]))), reset())
          : [tx, ty];
      },
      reflectX: function (_) {
        return arguments.length
          ? ((transform$$1 = scaleTranslate(k * (sx = _ ? -1 : 1), k * sy, tx, ty)), reset())
          : sx < 0;
      },
      reflectY: function (_) {
        return arguments.length
          ? ((transform$$1 = scaleTranslate(k * sx, k * (sy = _ ? -1 : 1), tx, ty)), reset())
          : sy < 0;
      },
  ...
  naturalEarth1Raw.invert = function (x, y) {
    ...
    do {
      ...
      phi -= delta =
        ...
        (1.007226 +
          phi2 *
            (0.015085 * 3 + phi4 * (-0.044475 * 7 + 0.028874 * 9 * phi2 - 0.005916 * 11 * phi4)));
    } while (abs(delta) > epsilon$2 && --i > 0);
    return [
      x /
        (0.8707 +
          (phi2 = phi * phi) *
            (-0.131979 + phi2 * (-0.013791 + phi2 * phi2 * phi2 * (0.003971 - 0.001529 * phi2)))),
      phi
    ];
  };
  ...
  function index$2() {
    ...
    pack.padding = function (x) {
      return arguments.length
        ? ((padding = typeof x === 'function' ? x : constant$8(+x)), pack)
        : padding;
    };
  ...
  function index$3() {
    ...
    treemap.paddingInner = function (x) {
      return arguments.length
        ? ((paddingInner = typeof x === 'function' ? x : constant$8(+x)), treemap)
        : paddingInner;
    };
    ...
    treemap.paddingTop = function (x) {
      return arguments.length
        ? ((paddingTop = typeof x === 'function' ? x : constant$8(+x)), treemap)
        : paddingTop;
    };

    treemap.paddingRight = function (x) {
      return arguments.length
        ? ((paddingRight = typeof x === 'function' ? x : constant$8(+x)), treemap)
        : paddingRight;
    };

    treemap.paddingBottom = function (x) {
      return arguments.length
        ? ((paddingBottom = typeof x === 'function' ? x : constant$8(+x)), treemap)
        : paddingBottom;
    };

    treemap.paddingLeft = function (x) {
      return arguments.length
        ? ((paddingLeft = typeof x === 'function' ? x : constant$8(+x)), treemap)
        : paddingLeft;
    };
  ...
  function computeUpperHullIndexes(points) {
    ...
    for (var i = 2; i < n; ++i) {
      while (
        size > 1 &&
        cross$1(points[indexes[size - 2]], points[indexes[size - 1]], points[i]) <= 0
      )
        --size;
      indexes[size++] = i;
    }
  ...
  var day = newInterval(
    ...
    function (start, end) {
      return (
        (end - start - (end.getTimezoneOffset() - start.getTimezoneOffset()) * durationMinute$1) /
        durationDay$1
      );
    },
    function (date) {
  ...
  function arc() {
    ...
    function arc() {
      ...
      // Or is it a circular or annular sector?
        ...
        var a01 = a0,
          ...
          rp =
            ap > epsilon$3 &&
            (padRadius ? +padRadius.apply(this, arguments) : sqrt$2(r0 * r0 + r1 * r1)),
        ...
        if (rc > epsilon$3) {
          ...
          if (da < pi$4) {
            var oc =
                da0 > epsilon$3 ? intersect(x01, y01, x00, y00, x11, y11, x10, y10) : [x10, y10],
              ax = x01 - oc[0],
              ay = y01 - oc[1],
              bx = x11 - oc[0],
              by = y11 - oc[1],
    ...
    arc.innerRadius = function (_) {
      return arguments.length
        ? ((innerRadius = typeof _ === 'function' ? _ : constant$10(+_)), arc)
        : innerRadius;
    };

    arc.outerRadius = function (_) {
      return arguments.length
        ? ((outerRadius = typeof _ === 'function' ? _ : constant$10(+_)), arc)
        : outerRadius;
    };

    arc.cornerRadius = function (_) {
      return arguments.length
        ? ((cornerRadius = typeof _ === 'function' ? _ : constant$10(+_)), arc)
        : cornerRadius;
    };

    arc.padRadius = function (_) {
      return arguments.length
        ? ((padRadius = _ == null ? null : typeof _ === 'function' ? _ : constant$10(+_)), arc)
        : padRadius;
    };

    arc.startAngle = function (_) {
      return arguments.length
        ? ((startAngle = typeof _ === 'function' ? _ : constant$10(+_)), arc)
        : startAngle;
    };

    arc.endAngle = function (_) {
      return arguments.length
        ? ((endAngle = typeof _ === 'function' ? _ : constant$10(+_)), arc)
        : endAngle;
    };

    arc.padAngle = function (_) {
      return arguments.length
        ? ((padAngle = typeof _ === 'function' ? _ : constant$10(+_)), arc)
        : padAngle;
    };
  ...
  function line() {
    ...
    line.x = function (_) {
      return arguments.length
        ? ((x$$1 = typeof _ === 'function' ? _ : constant$10(+_)), line)
        : x$$1;
    };

    line.y = function (_) {
      return arguments.length
        ? ((y$$1 = typeof _ === 'function' ? _ : constant$10(+_)), line)
        : y$$1;
    };

    line.defined = function (_) {
      return arguments.length
        ? ((defined = typeof _ === 'function' ? _ : constant$10(!!_)), line)
        : defined;
    };
  ...
  function area$2() {
    ...
    area.x = function (_) {
      return arguments.length
        ? ((x0 = typeof _ === 'function' ? _ : constant$10(+_)), (x1 = null), area)
        : x0;
    };
    ...
    area.x1 = function (_) {
      return arguments.length
        ? ((x1 = _ == null ? null : typeof _ === 'function' ? _ : constant$10(+_)), area)
        : x1;
    };

    area.y = function (_) {
      return arguments.length
        ? ((y0 = typeof _ === 'function' ? _ : constant$10(+_)), (y1 = null), area)
        : y0;
    };
    ...
    area.y1 = function (_) {
      return arguments.length
        ? ((y1 = _ == null ? null : typeof _ === 'function' ? _ : constant$10(+_)), area)
        : y1;
    };
    ...
    area.defined = function (_) {
      return arguments.length
        ? ((defined = typeof _ === 'function' ? _ : constant$10(!!_)), area)
        : defined;
    };
  ...
  function pie() {
    ...
    pie.value = function (_) {
      return arguments.length
        ? ((value = typeof _ === 'function' ? _ : constant$10(+_)), pie)
        : value;
    };
    ...
    pie.startAngle = function (_) {
      return arguments.length
        ? ((startAngle = typeof _ === 'function' ? _ : constant$10(+_)), pie)
        : startAngle;
    };

    pie.endAngle = function (_) {
      return arguments.length
        ? ((endAngle = typeof _ === 'function' ? _ : constant$10(+_)), pie)
        : endAngle;
    };

    pie.padAngle = function (_) {
      return arguments.length
        ? ((padAngle = typeof _ === 'function' ? _ : constant$10(+_)), pie)
        : padAngle;
    };
  ...
  function link$2(curve) {
    ...
    link.x = function (_) {
      return arguments.length
        ? ((x$$1 = typeof _ === 'function' ? _ : constant$10(+_)), link)
        : x$$1;
    };

    link.y = function (_) {
      return arguments.length
        ? ((y$$1 = typeof _ === 'function' ? _ : constant$10(+_)), link)
        : y$$1;
    };
  ...
  function symbol() {
    ...
    symbol.type = function (_) {
      return arguments.length
        ? ((type = typeof _ === 'function' ? _ : constant$10(_)), symbol)
        : type;
    };

    symbol.size = function (_) {
      return arguments.length
        ? ((size = typeof _ === 'function' ? _ : constant$10(+_)), symbol)
        : size;
    };
  ...
  function stack() {
    ...
    stack.keys = function (_) {
      return arguments.length
        ? ((keys = typeof _ === 'function' ? _ : constant$10(slice$6.call(_))), stack)
        : keys;
    };

    stack.value = function (_) {
      return arguments.length
        ? ((value = typeof _ === 'function' ? _ : constant$10(+_)), stack)
        : value;
    };
    ...
    stack.order = function (_) {
      return arguments.length
        ? ((order =
            _ == null ? none$2 : typeof _ === 'function' ? _ : constant$10(slice$6.call(_))),
          stack)
        : order;
    };
  ...
  function voronoi() {
    ...
    voronoi.x = function (_) {
      return arguments.length
        ? ((x$$1 = typeof _ === 'function' ? _ : constant$11(+_)), voronoi)
        : x$$1;
    };

    voronoi.y = function (_) {
      return arguments.length
        ? ((y$$1 = typeof _ === 'function' ? _ : constant$11(+_)), voronoi)
        : y$$1;
    };
  ...
  function zoom() {
    ...
    zoom.wheelDelta = function (_) {
      return arguments.length
        ? ((wheelDelta = typeof _ === 'function' ? _ : constant$12(+_)), zoom)
        : wheelDelta;
    };

    zoom.filter = function (_) {
      return arguments.length
        ? ((filter = typeof _ === 'function' ? _ : constant$12(!!_)), zoom)
        : filter;
    };

    zoom.touchable = function (_) {
      return arguments.length
        ? ((touchable = typeof _ === 'function' ? _ : constant$12(!!_)), zoom)
        : touchable;
    };
